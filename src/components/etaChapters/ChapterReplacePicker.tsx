 ...
 * `ChapterReplacePickerContent` because a component can't read a `Provider` it renders itself
...
function ChapterReplacePickerContent({
  visible,
  targetChapter,
  myChapters,
  isSubmitting,
